...
RootModule = 'PSNativeCmdDevKit.psm1'
...
GUID = 'f0ae3654-6b89-47cb-92b5-7c65b8a1f13d'
...
FunctionsToExport = @('Add-SudoPreferenceRule','Get-PropertyHashFromListOutput','Get-SudoPreference','Get-SudoPreferenceRule','Invoke-NativeCommand','Remove-SudoPreferenceRule')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Native', 'Linux', 'Windows')

        # A URL to the license for this module.
        # LicenseUri = ''

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/dsccommunity/PSNativeCmdDevKit'
